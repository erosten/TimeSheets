...
/**
 * Extends <code>javax.swing.ButtonGroup</code> to provide methods that allow working with button
 * references instead of button models.
 * 
 * @author Daniel Tofan
...
public class JButtonGroup extends ButtonGroup {
  ...
  private static final long serialVersionUID = 256612143773245167L;
  /**
  ...
  /**
   * Creates a <code>JButtonGroup</code> object from an array of buttons and adds the buttons to the
   * group No button will be selected initially.
   * 
   * @param buttons
   *          an array of <code>AbstractButton</code>s
   */
   ...
   * 
   * @param button
   *          an <code>AbstractButton</code> reference
   */
  @Override
   ...
   *          an <code>AbstractButton</code> reference
   * @param selected
   *          an <code>boolean</code> representing the selection state of the button
   */
   ...
   * 
   * @param model
   *          a <code>ButtonModel</code> reference
   * @param selected
   *          an <code>boolean</code> representing the selection state of the button
   */
  @Override
  ...
  /**
   * Returns the <code>AbstractButton</code> whose <code>ButtonModel</code> is given. If the model
   * does not belong to a button in the group, returns null.
   * 
   * @param model
   *          a <code>ButtonModel</code> that should belong to a button in the group
   * @return an <code>AbstractButton</code> reference whose model is <code>model</code> if the
   *         button belongs to the group, <code>null</code>otherwise
   */
  public AbstractButton getButton(ButtonModel model) {
    final Iterator<AbstractButton> it = buttons.iterator();
    while (it.hasNext()) {
      final AbstractButton ab = it.next();
   ...
   * 
   * @return a reference to the currently selected button in the group or <code>null</code> if no
   *         button is selected
   */
   ...
   * 
   * @return a <code>List</code> containing the buttons in the group, in the order they were added
   *         to the group
   */
   ...
   * 
   * @param button
   *          the button you'd like to check exists
